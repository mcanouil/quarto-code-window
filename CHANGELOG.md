...
- fix: Write the syntax highlighting definitions into a Typst document that has inline code and no code block. Such a document failed to compile before, because the definitions never reached it.
